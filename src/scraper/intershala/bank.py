...
logger = logging.getLogger("intershala.bank")

async def scrape_internshala_bank():
    URL = "https://internshala.com/internships/bank-internship/"
    ...
    logger.info(f"Scraped {len(internships)} bank internships from Internshala.")
    return internships
...
if __name__ == "__main__":
    import asyncio
    jobs = asyncio.run(scrape_internshala_bank())
    logger.info(f"Scraped {len(jobs)} internships from Internshala.")
